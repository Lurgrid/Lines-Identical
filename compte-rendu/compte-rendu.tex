...
2       1       bugs
    ...
    Windows qui préférerait utiliser le `\symbol{92}' au `-'), l'identificateur des deux 
...
0,01s user 0,01s system 98`\%` cpu 0,019 total
    ...
    chaque ligne devra être calculée par la fonction de hachage. Or cette fonction 
...
9,46s user 0,71s system 99`\%` cpu 10,169 total
    ...
    c'est-à-dire avec l'utilisation de la table de hachage tout simplement, car 
...
heap usage: 254 allocs, 254 frees, 33,573,081 bytes allocated
    ...
    moitié de la mémoire utilisée. Tout au long de l'exécution il a donc utilisé:
