...
2       1       bugs
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \node[draw, minimum size=1cm, below left=-0.75cm of struct.center] (child1) {3};
            ...
            \draw[->, ultra thick, line width=1.5pt] (child2.mid) .. controls +(up:28mm) and +(up:14mm) .. (chain.north);
            \draw[fill=black] (child2.mid) ++(0,-0.1cm) circle (0.07);

            \node[draw, minimum size=1cm, above=-1cm of chain.north] (node1) {};
            \node[draw, minimum size=1cm, below=0cm of node1.south] (node2) {};
            \node[draw, minimum size=1cm, below=0cm of node2.south] (node3) {};
            \node[draw, minimum size=1cm, below=0cm of node3.south] (node4) {};

            \draw[fill=black] (node1.mid) ++(0,-0.1cm) circle (0.07);
        
            \node[draw, minimum size=1cm, right= of node1] (next11) {};
            \node[draw, minimum size=1cm, right= of next11] (next12) {};
            \node[draw, minimum size=1cm, right= of next12] (next13) {};


            \draw (node2.south west) -- (node2.north east);
            \draw (node2.north west) -- (node2.south east);

            \node[draw, minimum size=1cm, right= of node3] (next31) {};
...
0,07s user 0,00s system 99`\%` cpu 0,061 total
    ...
    et celui de personne aillant réalisé un projet similaire.
