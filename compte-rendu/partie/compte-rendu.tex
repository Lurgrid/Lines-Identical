...
\begin{document}
    ...
    \begin{abstract}
        ...
        implémentation, mais aussi nous débrifferons de la production de ce 
        projet.
    \end{abstract}
    ...
    % Fichier test commun (gros petit)
    % Fichier particulier (grosse ligne) (beaucoup de ligne)
    ...
    % Difficulté rencontré (pur rédaction) (du mal a s'arrêter)
    % touche d'humour le LaTex

    \subsection{Remerciment}

    % illyes
    % Erwan
    % Madame Gonsalvez (latex)
    % Soeur théo
    % ChatGPT (latex, ortographe)
