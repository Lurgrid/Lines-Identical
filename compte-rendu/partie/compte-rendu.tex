...
\begin{document}
    ...
    \begin{abstract}
        ...
        projet. Puis, nous suivrons par la façon dont nous avons décidé de le 
        construite. Ensuite, nous verrons plus en détailles des divers modules 
        utilisé. Enfin, nous présenterons une mise en pratique avec des tests 
        intéressant mais aussi de performance. Pour conclure, nous aborderons 
        les diverses limitations et possible amélioration de cette 
        implémentation, mais aussi nous dibrifferons de la production de ce 
        projet.
    \end{abstract}
    ...
    disponible ajoutant des fonctionnalités. Voir ci-dessous pour leurs 
    ...
    \begin{figure}[ht]
        ...
        \begin{tabular}{|c|c|c|}
            ...
            \hline
                ...
                standart la documentation de l'executable.}\\
            \hline
    ...
    (voir shéma d'implémentaion du module hastable figure \ref{hastable-fig}). De 
    ...
    Ces dans ce cas, que toutes les allocations devraient être désalloué et alors, il 
    ...
    pourrait plus ou moins les parcourir simplément selon cette structure. On 
    ...
    Dans notre projet, de nombreuses donnés sont alloué dynamiquement. Les lignes
    lu, les numéros de ces lignes. C'est pour cela que l'utilisation du 
    `four-tout' est tous à fait justifier. De ce fait, les structures provenant 
    du module da et avl n'ont absolument pas besoin d'avoir des opérations tel 
    que la libération de mémoire pour les valeurs qu'elles contiennent. De ce 
    fait, l'utilisation du `four-tout' permet la simplification du dévellopement
    de certain module (par les gestions des donnés contenu dans les structures 
    qui reviennent à l'utilisateur), mais aussi une certainnes lisibilité dans 
    le code (On voit très bien dans lnid.c, que les lignes et leurs compteurs 
    sont stocké tous deux dans des fourts touts). 
    ...
    garantie une recherche au maximum en temps logarithemique. Mais un ajout dans 
