            ...
            \WHILE{argument \textbf{de} tableau-argument}
                ...
                \ELSIF{argument est une option longue}
                    \STATE{
                        ...
                        \begin{minipage}[c][8ex]{10cm}
                            ...
                            a la fonction opt\_parse\_long vise a trouver 
                            l'option dont argument est le seul préfix. 
                        \end{minipage}
                        }
                        \vspace{\spacebox}
                        }
                \ELSIF{argument est une option courte}
                    \STATE{
                        ...
                        \begin{minipage}[c][8ex]{10cm}
                            Traitement des possibles options courtes 
                        \end{minipage}
                        }
                        \vspace{\spacebox}
                        }
